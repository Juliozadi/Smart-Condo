...
const testes = {
  paragrafos: [
    ...
    'Além da suíte do servidor, 56 testes de interface abrem as telas em um navegador Chromium real, nos temas claro e escuro, em largura de computador e de celular. Eles conferem o que já falhou uma vez e não pode voltar: erros de JavaScript, imagens quebradas, rolagem lateral no celular, a barra superior fora do topo, títulos e cartões sem ícone, caixas claras no tema escuro, elementos marcados como escondidos que continuavam aparecendo, a logo levando ao painel de cada perfil, o medidor de força da senha e formulário que pede um dado que nenhum código lê — dado pessoal coletado à toa. Três deles percorrem os fluxos com arquivo de ponta a ponta: a captura pela câmera, com uma câmera simulada do navegador, a foto tirada pelo porteiro chegando ao painel do morador, e os documentos escolhidos no cadastro chegando à fila de aprovação do síndico. Também rodam a cada envio, com o banco, a API e o site no ar.',
