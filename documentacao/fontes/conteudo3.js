...
const testes = {
  paragrafos: [
    'As regras do sistema são verificadas por uma suíte de 343 casos de teste automatizados, escritos com pytest e executados contra um banco PostgreSQL real, e não contra um banco simulado. Assim, restrições de chave estrangeira e de unicidade também são exercitadas.',
...
const conclusao = [
  ...
  'Até o momento, o sistema conta com as quatro áreas de acesso implementadas e ligadas à API, 21 tabelas em PostgreSQL, 99 endpoints, 343 casos de teste automatizados cobrindo as regras de negócio e 59 testes de interface executados em um navegador real.',
